/-
# MiniHomologyTheory.Constructions.MappingCone
...
/-- Mapping cone of f: C -> D. -/
axiom mappingCone : True

/-- Exact triangle: C -> D -> Cone(f) -> C[-1]. -/
axiom exactTriangle : True

/-- Long exact sequence from mapping cone. -/
axiom coneLongExactSequence : True

#eval "=== Mapping Cone ==="
#eval "Cone(f)_n = C_{n-1} ⊕ D_n"
#eval "d(c, d) = (-d_C(c), d_D(d) - f(c))"
#eval "Exact triangle: C -> D -> Cone(f) -> C[-1]"
