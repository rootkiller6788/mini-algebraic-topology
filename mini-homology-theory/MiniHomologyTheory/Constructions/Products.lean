/-
# MiniHomologyTheory.Constructions.Products
Products, tensor products, Kunneth theorem.
-/
...
axiom tensorProductComplex : True

/-- Kunneth theorem. -/
axiom kunnethTheorem : True

/-- Direct sum of chain complexes. -/
axiom directSumComplex : True

/-- Universal coefficient theorem. -/
axiom universalCoefficientTheorem : True

#eval "=== Constructions: Products ==="
#eval "C ⊗ D: (C⊗D)_n = ⊕_{p+q=n} C_p ⊗ D_q"
#eval "Kunneth: 0 -> ⊕ H_p⊗H_q -> H_n(C⊗D) -> ⊕ Tor(H_p,H_q) -> 0"
#eval "Universal coefficient: 0 -> H_n⊗G -> H_n(;G) -> Tor(H_{n-1},G) -> 0"
